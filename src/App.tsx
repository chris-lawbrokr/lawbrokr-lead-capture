...
function App() {
  return (
     ...
     * the two fills lines up exactly with the boundary between the panels at
     * every width.
     */
    <div className="relative min-h-screen bg-card before:absolute before:inset-y-0 before:left-0 before:w-1/2 before:bg-primary before:content-['']">
